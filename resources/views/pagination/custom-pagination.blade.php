@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between flex-row-reverse">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                <option @if ($page == $paginator->currentPage()) selected @endif value="{{$page}}">{{$page}}</option>
                            @endforeach
                        @endif
