...
class ExpenseTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($this->adminTypes as $t){
            ExpenseType::create(["name" => $t, "is_admin" => 1]);
        }
    }
}
